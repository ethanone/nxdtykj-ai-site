...
export const ProjectModal = memo(({ isOpen, onClose, language }: ProjectModalProps) => {
  ...
  const content = language === 'zh' ? {
    title: "项目简介｜ PM系列智能体-工时定额设计智能体",
    sections: [
      {
        title: "项目简介",
        content: "工时定额设计智能体是一款面向制造业工程师与精益团队的工业工程智能分析系统。它以标准工时为核心，融合工时测定、动作分析、人机协作、OEE 计算与产线平衡等工业工程方法，通过交互式对话 + 自动分析的方式，帮助企业快速、可靠地完成工序分析与定额设计。",
